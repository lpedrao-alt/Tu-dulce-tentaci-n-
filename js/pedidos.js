...
function calcularPedido() {
    ...
    document.querySelectorAll(
        '#listaSalsas input[type="checkbox"]:checked'
    )
   ...
   const toppingsSeleccionados =
    Array.from(
    document.querySelectorAll(
        '#listaToppings input[type="checkbox"]:checked'
    )
     ).map(check => check.value);
...
function limpiarFormulario() {
   ...
   document
    .querySelectorAll('#listaSalsas input[type="checkbox"]')
